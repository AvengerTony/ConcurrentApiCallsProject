...
interface ApiService {
    ...
    @POST
    suspend fun postApiCallWithEndPontNJsonBody(@Url endPoint: String,@Body body: JsonElement?): JsonElement

    @FormUrlEncoded
    @POST
    suspend  fun postApiCallWithEndPontNFieldMap(@Url endPoint: String,@FieldMap fieldMap: Map<String, String>): JsonElement
